...
local c = require 'rootbeet.colors'
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Directory { fg = c.black }, -- Directory names (and other special names in listings)
    Added { fg = c.green.da(10) },
    Changed { fg = c.brown },
    Removed { fg = c.red },
    ...
    -- LineNr { Folded, fg = c.black.da(50) },                  -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    Comment { fg = c.white.da(20), gui = 'italic' }, -- Any comment
